...
np.save(os.path.join(root_dir, 'sclab', 'promoter', 'train_dataset.npy'), train_dataset)
np.save(os.path.join(root_dir, 'sclab', 'promoter', 'eval_dataset.npy'), eval_dataset)