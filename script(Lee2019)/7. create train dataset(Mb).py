...
np.save(os.path.join(root_dir, 'sclab', 'Mb', 'train_dataset.npy'), train_dataset)
np.save(os.path.join(root_dir, 'sclab', 'Mb', 'eval_dataset.npy'), eval_dataset)